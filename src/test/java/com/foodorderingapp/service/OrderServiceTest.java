...
public class OrderServiceTest {
    ...
    OrderRequestDto o;
    FoodQuantityRequestDto fq;
    @Before
    public void setUp() throws Exception {
        MockitoAnnotations.initMocks(this);
        fq=new FoodQuantityRequestDto("momo",100,"kfc",1);
        o=new OrderRequestDto(1,Arrays.asList(fq));
    }

    @Rule
    public ExpectedException expectedException = ExpectedException.none();

    public OrderRequestDto add(){
        ordersService.add(o);
        return o;
    }
    ...
    public void add_thenResultOrder() {
        ...
        when(userService.getUser(o.getUserId())).thenReturn(new UserResponseDto());
        when(orderUtil.getOrderResponseDto(o,orders)).thenReturn(new OrderResponseDto());
        Assert.assertEquals(ordersService.add(o), new OrderResponseDto());
    }
    ...
    public void testToUpdateOrder() {
        ...
        when(userService.update(new UserRequestDto()))
                .thenReturn(new UserResponseDto());
        when(userService.getUser(orders.getUser().getUserId())).thenReturn(new UserResponseDto());
    ...
    @Test
    public void addWhenThereNoSuchUserInTheUserTable_thenResultNull() {
        expectedException.expect(DataNotFoundException.class);
        expectedException.expectMessage("user cannot be null.");
        ordersService.add(o);
    }
   ...
   @Test
    ...
    @Test
    public void getUsersByUserForAMonth_whenGetUserListDtoThenReturnNull_thenReturnDataNotFoundException() {
        UserListMapperDto userListMapperDto=new UserListMapperDto(1,1,new Date(),true);
